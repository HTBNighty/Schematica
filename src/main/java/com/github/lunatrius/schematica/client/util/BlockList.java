...
public class BlockList {
    ...
    // This feels kinda retarded
    public <T extends Collection<WrappedItemStack>> T fillCollection(final EntityPlayer player, final SchematicWorld world, final World mcWorld, T blockList) {
        if (world == null) {
            return blockList;
        }
    ...
    private <T extends Collection<WrappedItemStack>> WrappedItemStack findOrCreateWrappedItemStackFor(final T blockList, final ItemStack itemStack) {
        for (final WrappedItemStack wrappedItemStack : blockList) {
            if (wrappedItemStack.itemStack.isItemEqual(itemStack)) {
                return wrappedItemStack;
            }
